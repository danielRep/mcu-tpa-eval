...
#define N_MBBS              10                      /* number of MBBs + entrypoint MBB*/
#define N_SUPP_EDGES        TOTAL_HW_BKPTS          /* number of supported edges per MBB (= hw breakpoints supported by the platform) */
#define LOG_MBB_HIT_SIZE    810                     /* number of MBBs hits allowed to be logged */

static uint32_t t_n_time = 1389240;                 /* nominal time of the current MBB */
