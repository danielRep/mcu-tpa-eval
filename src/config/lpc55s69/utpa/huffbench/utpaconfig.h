...
#define LOG_MBB_HIT_SIZE    500                     /* number of MBBs hits allowed to be logged */

static uint32_t t_n_time = 309253;                 /* nominal time of the current MBB */
static float alpha = 1.5;                           /* alpha is the accepted amount of the controlled degradation */
